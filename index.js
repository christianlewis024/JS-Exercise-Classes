...
class Instructor extends Lambdasian {
  constructor(argumentKeys) {
    super(argumentKeys);
    this.specialty = argumentKeys.specialty;
    this.favLanguage = argumentKeys.favLanguage;
    this.catchPhrase = argumentKeys.catchPhrase;
  }
  demo(subject) {
...
class ProjectManager extends Instructor {
  constructor(managerKey) {
    super(managerKey);
    this.gradClassName = managerKey.gradClassName;
    this.favInstructor = managerKey.favInstructor;
  }
  standUp(channel) {
